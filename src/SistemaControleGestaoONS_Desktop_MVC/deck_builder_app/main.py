...
# PROJECT: Deck Builder Application
# V: 1.0.0
#
# ///////////////////////////////////////////////////////////////
...
#from gui.iframes.deck_builder_widget import DeckBuilderWidget
...
class MainWindow(QMainWindow):
    def __init__(self, app):
        ...
        self.settings_model = SettingsModel(file_path="deck_builder_settings.json")
    ...
    def connect_signals(self):
        # Main Navigation
        #self.navigation_menu.deck_builder_requested.connect(self.open_deck_builder_tab)
    ...
    #def open_deck_builder_tab(self): self.open_or_focus_tab("Deck Builder", DeckBuilderWidget)
