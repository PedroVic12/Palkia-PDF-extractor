...
try:
    ...
    print("Dependências críticas não encontradas.")
...
QPushButton#filterButton, QPushButton#run_button {
    background-color: #3B82F6;
    color: white;
    border: none;
    border-radius: 6px;
...
QPushButton#filterButton:hover, QPushButton#run_button:hover {
...
QPushButton#export_excel:hover {
...
class PDFExtractionWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Header
        title = QLabel("Extração de Dados de PDF")
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # Widget empilhado para as diferentes telas
